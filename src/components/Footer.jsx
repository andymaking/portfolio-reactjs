        ...
        <footer className='w-full flex flex-col' ref={ref}>
            ...
            <div className="copyright flex flex-row justify-between items-center">
                <div className='social-media flex flex-row justify-start items-center'>
                    <Link target='_blank' type={"primary"} href={"https://twitter.com/thejudejoshua"}>
                    ...
                    <Link target='_blank' type={"primary"} href={"https://instagram.com/the.jude.joshua"}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                    ...
                    <Link target='_blank' type={"primary"} href={"https://linkedin.com/in/thejudejoshua"}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">

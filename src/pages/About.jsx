            ...
            <section className="main w-full flex flex-col items-center">
                <article className="bio-container w-full flex flex-row justify-start items-start">
                    ...
                    <div className="content flex flex-col items-start justify-start">
                        <p className="p1">I am Jude Joshua, a digital product designer, currently at FirstMedtrade Africa. Since 2017, I have collaborated with brands and businesses to design visually appealing and user-friendly digital experiences for their mobile apps and websites.</p>
                        ...
                        <p className="p1">Presently, I am actively pursuing opportunities that challenge my expertise, prioritize user needs, and enable me to deliver exceptional results.</p>
                    </div>
                </article>
